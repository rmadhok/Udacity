...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    gg = ggplot(year_hr, aes(x='yearID', y='HR', color='teamID')) + \
                geom_line() + ggtitle('Home Runs by Year and Team') + \
                xlab('Year') + ylab('Homeruns')

    return gg

print lineplot_compare('/Users/rmadhok/Documents/MOOC/Udacity/Data Science/data/hr_by_team_year_sf_la.csv')
