...
def lineplot(hr_year_csv):
    ...
    gg = ggplot(df, aes('yearID', 'HR')) + geom_point(color = 'red') + geom_line(color = 'red') + ggtitle('Yearly Home Runs') + xlab('Year') + ylab('Number of Homeruns')

    gg.draw()

lineplot('/Users/rmadhok/Documents/MOOC/Udacity/Data Science/data/hr_year.csv')
