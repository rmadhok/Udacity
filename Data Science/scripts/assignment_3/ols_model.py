...
def predictions(weather_turnstile):
    ...
    x = weather_turnstile[['rain', 'Hour', 'meantempi', 'fog', 'thunder']]
    dummy_units = pandas.get_dummies(weather_turnstile['UNIT'], prefix='unit')
    x = x.join(dummy_units)
    # 'maxpressurei','maxdewpti','mindewpti','minpressurei','meandewpti','meanpressurei','fog','rain','meanwindspdi','mintempi','meantempi', 'maxtempi', 'precipi', 'thunder']]
...
predictions('/Users/rmadhok/Documents/MOOC/Udacity/Data Science/data/turnstile_data_master_with_weather.csv')
